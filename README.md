...
- `AGENTS.md` (required)
- `src/app.aos`
- `src/Assets/icons/app.svg` (single canonical icon source)
- `src/Assets/images/` (optional)
- `src/Assets/fonts/` (optional)
- `src/Assets/styles/` (future)
- `src/Assets/locale/en.toml` (optional)
- See `SPEC/APP_STRUCTURE.md` for the normative layout.
- `src/Targets/Apple/Mac/*` (optional platform overrides)
- `src/Targets/Microsoft/Windows/*` (optional platform overrides)
- `src/Targets/Linux/*` (optional platform overrides)
...
- Output:
  - `<project-path>/src/Assets/icons/app.svg`
  - `<project-path>/src/Assets/icons/manifest.txt`
